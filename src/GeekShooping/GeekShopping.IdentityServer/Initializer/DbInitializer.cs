    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            ApplicationUser admin = new ApplicationUser()
            {
                ...
                EmailConfirmed = true,
                PhoneNumber = "+55 (11) 95216-0511",
                FirstName = "Guilherme",
                LastName = "admin"
            };

            _user.CreateAsync(admin, "Gb123#").GetAwaiter().GetResult();
            ...
            ApplicationUser client = new ApplicationUser()
            {
                ...
                Email = "guilherme-client@erudio.com.br",
                EmailConfirmed = true,
                PhoneNumber = "+55 (11) 95216-0511",
                FirstName = "guilherme",
                LastName = "Client"
            ...
            _user.CreateAsync(client, "GuiBarbosa123$").GetAwaiter().GetResult();
